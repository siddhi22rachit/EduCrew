...
import { Edit2, MessageCircle, Crown, CheckCircle, Clock } from "lucide-react";
...
const Dashboard = () => {
  ...
  if (!group) return <p className="bg-black text-white p-4">Group not found.</p>;
    ...
    <div className="min-h-screen bg-black text-white p-2 md:p-6 lg:p-8">
      ...
      <div className="flex justify-between items-center bg-[#0A1128] rounded-lg p-4 mb-3">
        ...
        <div className="flex items-center space-x-4">
          <Edit2 className="text-blue-400 cursor-pointer hover:text-blue-600 w-6 h-6 md:w-8 md:h-8" />
